      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Starter Plan */}
            <div className="p-8 rounded-2xl border-2 border-gray-200 bg-white hover:shadow-xl transition-shadow">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-gray-600">Up to 1,000 API calls/month</span>
                </li>
                <li className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-green-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            ...
            {/* Pro Plan */}
            <div className="p-8 rounded-2xl border-2 border-blue-600 bg-white hover:shadow-xl transition-shadow relative">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-gray-600">Up to 10,000 API calls/month</span>
                </li>
                <li className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-green-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            ...
            <div className="p-8 rounded-2xl border-2 border-gray-200 bg-white hover:shadow-xl transition-shadow">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-gray-600">Custom model training</span>
                </li>
                <li className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-green-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
